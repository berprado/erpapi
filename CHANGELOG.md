...
- **Hallazgo durante la auditoria (ver `TODO.md`; resuelto en v12.10):** `HUARI 620ML` y `AMSTEL 620ML` (CERVEZAS) tienen `p_unidad_medida=11` en el catalogo real -- calificarian como pesables bajo el criterio nuevo, reabriendo sin decision de negocio el incidente de la operativa 1263 (2026-07-30, revertido en su momento) que fue precisamente el motivo original de excluir esa categoria.
