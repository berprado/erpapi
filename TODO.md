...
- [ ] **Aplicar en `production` (casa matriz y Beer Garden) los cambios de PESAJE de la sesión 2026-09-08/10** (backfills + nuevo criterio de `pesable` por unidad de medida, PRs #7/#8/#9): guía paso a paso completa en `documentos/runbook_despliegue_pesaje_unidad_medida.md`. `test_pos` ya completado (2026-09-10). Repetir por cada base real (casa matriz y Beer Garden tienen catálogos independientes, no es una sola "producción").
